...
export PATH="$HOME/.local/bin:$BIN:$DEFAULT_PATH:$HOME/.config/nvm/versions/node/v14.15.4/bin:$HOME/.rvm/bin:$HOME/.yarn/bin:$HOME/.config/yarn/global/node_modules/.bin:$BIN/git-extras:$HOME/.local/texlive/2020/bin/x86_64-linux:$CARGO_HOME/bin:$GEM_HOME/bin:$RVM_DIR/rubies/default/bin"

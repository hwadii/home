...
set_keymap("n", "<Leader>tc", "<cmd>Telescope git_commits<cr>", opts)
set_keymap("n", "<Leader>to", "<cmd>Telescope lsp_document_symbols<cr>", opts)
set_keymap("n", "<Leader>tr", "<cmd>Telescope lsp_references<cr>", opts)
set_keymap("n", "<Leader>te", "<cmd>Telescope resume<cr>", opts)
...
set_keymap("n", "<Leader>ga", "<cmd>Gina branch<cr>", opts)
...
-- colorizer
set_keymap("n", "<Leader>c", "<cmd>ColorizerToggle<cr>", { noremap = true, silent = false })
